...
public class QuizPanel extends JPanel {
    ...
    public QuizPanel(MainController controller, AppStateModel appState) {
        ...
        opt1.setFont(new Font("Arial", Font.PLAIN, 14));
        opt1.setForeground(Color.BLACK);
        opt1.setOpaque(false);
        opt2.setFont(new Font("Arial", Font.PLAIN, 14));
        opt2.setForeground(Color.BLACK);
        opt2.setOpaque(false);
        opt3.setFont(new Font("Arial", Font.PLAIN, 14));
        ...
        group.add(opt3);
        oGbc.gridy = 0;
        optionsPanel.add(opt1, oGbc);
        oGbc.gridy = 1;
        optionsPanel.add(opt2, oGbc);
        oGbc.gridy = 2;
        optionsPanel.add(opt3, oGbc);
        gbc.gridy = 2;
        gbc.weighty = 0.55;
        ...
        if (defaultIcon != null) {
            ...
            submitBtnLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseEntered(MouseEvent e) {
                    if (hoverIcon != null) {
                        submitBtnLabel.setIcon(hoverIcon);
                    }
                }
    ...
    private void processAnswer() {
        ...
        if (opt1.isSelected()) {
            targetChoiceIndexString = "1";
        } else if (opt2.isSelected()) {
            targetChoiceIndexString = "2";
        } else if (opt3.isSelected()) {
            targetChoiceIndexString = "3";
        }
