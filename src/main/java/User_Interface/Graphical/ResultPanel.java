...
public class ResultPanel extends JPanel {
 ...
 gbc.gridy = 0; gbc.weighty = 0.2; gbc.insets = new Insets(40, 30, 10, 30);
 ...
 gbc.gridy = 1; gbc.weighty = 0.8; gbc.insets = new Insets(10, 30, 40, 30);
 ...
 @Override
 public void mouseEntered(MouseEvent e) { if (hoverIcon != null) nextBtnLabel.setIcon(hoverIcon); }
 @Override
 public void mouseExited(MouseEvent e) { if (defaultIcon != null) nextBtnLabel.setIcon(defaultIcon); }
 @Override
 public void mouseClicked(MouseEvent e) { controller.advanceFromFeedback(); }
 });
